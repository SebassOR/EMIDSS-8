...
#define SIUL2_DIO_IP_AR_RELEASE_MINOR_VERSION_C      9
#define SIUL2_DIO_IP_AR_RELEASE_REVISION_VERSION_C   0
#define SIUL2_DIO_IP_SW_MAJOR_VERSION_C              7
...
static inline uint16 Siul2_Dio_Ip_Rev_Bit_16(uint16 value)
{
    ...
    for (i = 0U; i < 8U; i++)
    {
        ret |= ((((uint32)value >> i) & 1U) << (15U - i)) | ((((uint32)value << i) & 0x8000U) >> (15U - i));
    }
                                                  ...
                                                  )
{
    ...
    SIUL2_DIO_IP_DEV_ASSERT((boolean)(u8Siul2Instance <= DIO_NUM_SIUL2_INSTANCES_U8));
    SIUL2_DIO_IP_DEV_ASSERT((boolean)(u8PortId <= DIO_NUM_PORTS_U16));

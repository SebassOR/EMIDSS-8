...
#define LPSPI_IP_AR_RELEASE_MINOR_VERSION_IRQ_C       9
#define LPSPI_IP_AR_RELEASE_REVISION_VERSION_IRQ_C    0
#define LPSPI_IP_SW_MAJOR_VERSION_IRQ_C               7
...
ISR(Lpspi_Ip_LPSPI_0_IRQHandler)
{
    Lpspi_Ip_IrqHandler(LPSPI_IP_LPSPI_0); /* Call Lpspi_Ip_IrqHandler for instance 0 */
    EXIT_INTERRUPT();
}
        #if (LPSPI_IP_DMA_USED == STD_ON)
void Lpspi_Ip_LPSPI_0_IrqTxDmaHandler(void)
{
    Lpspi_Ip_IrqTxDmaHandler(LPSPI_IP_LPSPI_0); /* Call Lpspi_Ip_IrqTxDmaHandler for instance 0 */
}
void Lpspi_Ip_LPSPI_0_IrqRxDmaHandler(void)
{
    Lpspi_Ip_IrqRxDmaHandler(LPSPI_IP_LPSPI_0); /* Call Lpspi_Ip_IrqRxDmaHandler for instance 0 */
}
        #endif
    #endif
#endif
...
ISR(Lpspi_Ip_LPSPI_1_IRQHandler)
{
    Lpspi_Ip_IrqHandler(LPSPI_IP_LPSPI_1); /* Call Lpspi_Ip_IrqHandler for instance 1 */
    EXIT_INTERRUPT();
}
        #if (LPSPI_IP_DMA_USED == STD_ON)
void Lpspi_Ip_LPSPI_1_IrqTxDmaHandler(void)
{
    Lpspi_Ip_IrqTxDmaHandler(LPSPI_IP_LPSPI_1); /* Call Lpspi_Ip_IrqTxDmaHandler for instance 1 */
}
void Lpspi_Ip_LPSPI_1_IrqRxDmaHandler(void)
{
    Lpspi_Ip_IrqRxDmaHandler(LPSPI_IP_LPSPI_1); /* Call Lpspi_Ip_IrqRxDmaHandler for instance 1 */
}
        #endif
    #endif
#endif
...
ISR(Lpspi_Ip_LPSPI_2_IRQHandler)
{
    Lpspi_Ip_IrqHandler(LPSPI_IP_LPSPI_2); /* Call Lpspi_Ip_IrqHandler for instance 2 */
    EXIT_INTERRUPT();
}
        #if (LPSPI_IP_DMA_USED == STD_ON)
void Lpspi_Ip_LPSPI_2_IrqTxDmaHandler(void)
{
    Lpspi_Ip_IrqTxDmaHandler(LPSPI_IP_LPSPI_2); /* Call Lpspi_Ip_IrqTxDmaHandler for instance 2 */
}
void Lpspi_Ip_LPSPI_2_IrqRxDmaHandler(void)
{
    Lpspi_Ip_IrqRxDmaHandler(LPSPI_IP_LPSPI_2); /* Call Lpspi_Ip_IrqRxDmaHandler for instance 2 */
}
        #endif
    #endif
#endif
...
ISR(Lpspi_Ip_LPSPI_3_IRQHandler)
{
    Lpspi_Ip_IrqHandler(LPSPI_IP_LPSPI_3); /* Call Lpspi_Ip_IrqHandler for instance 3 */
    EXIT_INTERRUPT();
}
        #if (LPSPI_IP_DMA_USED == STD_ON)
void Lpspi_Ip_LPSPI_3_IrqTxDmaHandler(void)
{
    Lpspi_Ip_IrqTxDmaHandler(LPSPI_IP_LPSPI_3); /* Call Lpspi_Ip_IrqTxDmaHandler for instance 3 */
}
void Lpspi_Ip_LPSPI_3_IrqRxDmaHandler(void)
{
    Lpspi_Ip_IrqRxDmaHandler(LPSPI_IP_LPSPI_3); /* Call Lpspi_Ip_IrqRxDmaHandler for instance 3 */
}
        #endif
    #endif
#endif
...
ISR(Lpspi_Ip_LPSPI_4_IRQHandler)
{
    Lpspi_Ip_IrqHandler(LPSPI_IP_LPSPI_4); /* Call Lpspi_Ip_IrqHandler for instance 4 */
    EXIT_INTERRUPT();
}
        #if (LPSPI_IP_DMA_USED == STD_ON)
void Lpspi_Ip_LPSPI_4_IrqTxDmaHandler(void)
{
    Lpspi_Ip_IrqTxDmaHandler(LPSPI_IP_LPSPI_4); /* Call Lpspi_Ip_IrqTxDmaHandler for instance 4 */
}
void Lpspi_Ip_LPSPI_4_IrqRxDmaHandler(void)
{
    Lpspi_Ip_IrqRxDmaHandler(LPSPI_IP_LPSPI_4); /* Call Lpspi_Ip_IrqRxDmaHandler for instance 4 */
}
        #endif
    #endif
#endif
...
ISR(Lpspi_Ip_LPSPI_5_IRQHandler)
{
    Lpspi_Ip_IrqHandler(LPSPI_IP_LPSPI_5); /* Call Lpspi_Ip_IrqHandler for instance 5 */
    EXIT_INTERRUPT();
}
        #if (LPSPI_IP_DMA_USED == STD_ON)
void Lpspi_Ip_LPSPI_5_IrqTxDmaHandler(void)
{
    Lpspi_Ip_IrqTxDmaHandler(LPSPI_IP_LPSPI_5); /* Call Lpspi_Ip_IrqTxDmaHandler for instance 5 */
}
void Lpspi_Ip_LPSPI_5_IrqRxDmaHandler(void)
{
    Lpspi_Ip_IrqRxDmaHandler(LPSPI_IP_LPSPI_5); /* Call Lpspi_Ip_IrqRxDmaHandler for instance 5 */
}
        #endif
    #endif
#endif

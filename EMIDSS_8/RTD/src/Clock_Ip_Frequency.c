...
#define CLOCK_IP_FREQUENCY_SW_MAJOR_VERSION_C               7
...
uint64 Clock_Ip_Get_RTC_CLK_Frequency_TrustedCall(void);
...
static uint64 Clock_Ip_Get_FLEXCANC_CLK_Frequency(void);
#endif
...
#endif
#if defined(CLOCK_IP_HAS_FLEXCANC_CLK)
    &Clock_Ip_Get_FLEXCANC_CLK_Frequency,                            /* FLEXCANC_CLK                 */
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN8_CLK)
    &Clock_Ip_Get_FLEXCAN8_CLK_Frequency,                            /* FLEXCAN8_CLK                 */
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN9_CLK)
    &Clock_Ip_Get_FLEXCAN9_CLK_Frequency,                            /* FLEXCAN9_CLK                 */
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN10_CLK)
    &Clock_Ip_Get_FLEXCAN10_CLK_Frequency,                            /* FLEXCAN10_CLK                 */
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN11_CLK)
    &Clock_Ip_Get_FLEXCAN11_CLK_Frequency,                            /* FLEXCAN11_CLK                 */
#endif
...
#endif
#if defined(CLOCK_IP_HAS_FLEXCANC_CLK)
/* Return FLEXCANC_CLK frequency */
static uint64 Clock_Ip_Get_FLEXCANC_CLK_Frequency(void) {
    uint64 Frequency = Clock_Ip_apfFreqTableClkSrc[((IP_MC_CGM->MUX_20_CSS & MC_CGM_MUX_20_CSS_SELSTAT_MASK) >> MC_CGM_MUX_20_CSS_SELSTAT_SHIFT)]();         /*  Selector value */

    Frequency &= Clock_Ip_au32EnableDivider[((IP_MC_CGM->MUX_20_DC_0 & MC_CGM_MUX_20_DC_0_DE_MASK) >> MC_CGM_MUX_20_DC_0_DE_SHIFT)];                     /*  Divider enable/disable */
    Frequency /= ((((uint64)IP_MC_CGM->MUX_20_DC_0 & (uint64)MC_CGM_MUX_20_DC_0_DIV_MASK) >> (uint64)MC_CGM_MUX_20_DC_0_DIV_SHIFT) + 1U);                                        /*  Apply divider value */
    return Frequency;
}
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN8_CLK)
...
static uint64 Clock_Ip_Get_FLEXCAN8_CLK_Frequency(void) {
    uint64 Frequency = Clock_Ip_Get_FLEXCANC_CLK_Frequency();

    Frequency &= Clock_Ip_u32EnableGate[(IP_MC_ME->PRTN2_COFB2_STAT & MC_ME_PRTN2_COFB2_STAT_BLOCK92_MASK) >> MC_ME_PRTN2_COFB2_STAT_BLOCK92_SHIFT];
    return Frequency;
}
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN9_CLK)
...
static uint64 Clock_Ip_Get_FLEXCAN9_CLK_Frequency(void) {
    ...
    Frequency &= Clock_Ip_u32EnableGate[(IP_MC_ME->PRTN2_COFB2_STAT & MC_ME_PRTN2_COFB2_STAT_BLOCK93_MASK) >> MC_ME_PRTN2_COFB2_STAT_BLOCK93_SHIFT];
    return Frequency;
}
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN10_CLK)
...
static uint64 Clock_Ip_Get_FLEXCAN10_CLK_Frequency(void) {
    ...
    Frequency &= Clock_Ip_u32EnableGate[(IP_MC_ME->PRTN2_COFB2_STAT & MC_ME_PRTN2_COFB2_STAT_BLOCK94_MASK) >> MC_ME_PRTN2_COFB2_STAT_BLOCK94_SHIFT];
    return Frequency;
}
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN11_CLK)
...
static uint64 Clock_Ip_Get_FLEXCAN11_CLK_Frequency(void) {
    ...
    Frequency &= Clock_Ip_u32EnableGate[(IP_MC_ME->PRTN2_COFB2_STAT & MC_ME_PRTN2_COFB2_STAT_BLOCK95_MASK) >> MC_ME_PRTN2_COFB2_STAT_BLOCK95_SHIFT];
    return Frequency;
}
#endif
...
static uint64 Clock_Ip_Get_LPUART1_CLK_Frequency(void)
{
     ...
     defined(CLOCK_IP_DERIVATIVE_004) || defined(CLOCK_IP_DERIVATIVE_007) || defined(CLOCK_IP_DERIVATIVE_010) || \
...
uint64 Clock_Ip_Get_RTC_CLK_Frequency_TrustedCall(void)
{
    uint64 Frequency = Clock_Ip_apfFreqTableRTC_CLK[((IP_RTC->RTCC & RTC_RTCC_CLKSEL_MASK) >> RTC_RTCC_CLKSEL_SHIFT)]();                                     /*  Selector value */
...
static uint64 Clock_Ip_Get_GMAC0_TX_CLK_Frequency(void)
{
    ...
    Frequency /= ((((uint64)IP_MC_CGM->MUX_8_DC_0 & (uint64)MC_CGM_MUX_8_DC_0_DIV_MASK) >> (uint64)MC_CGM_MUX_8_DC_0_DIV_SHIFT) + 1U);                                     /*  Apply divider value */
    Frequency &= Clock_Ip_u32EnableGate[(IP_MC_ME->PRTN2_COFB1_STAT & MC_ME_PRTN2_COFB1_STAT_BLOCK33_MASK) >> MC_ME_PRTN2_COFB1_STAT_BLOCK33_SHIFT];
#if defined(CLOCK_IP_GMAC0_TX_CLK_DIV2_SUPPORTED)
    Frequency /= 2U;
#endif
    return Frequency;
}
...
static uint64 Clock_Ip_Get_GMAC_TX_CLK_Frequency(void)
{
    ...
    Frequency /= ((((uint64)IP_MC_CGM->MUX_8_DC_0 & (uint64)MC_CGM_MUX_8_DC_0_DIV_MASK) >> (uint64)MC_CGM_MUX_8_DC_0_DIV_SHIFT) + 1U);                                     /*  Apply divider value */
    Frequency &= Clock_Ip_u32EnableGate[(IP_MC_ME->PRTN2_COFB1_STAT & MC_ME_PRTN2_COFB1_STAT_BLOCK33_MASK) >> MC_ME_PRTN2_COFB1_STAT_BLOCK33_SHIFT];
#if defined(CLOCK_IP_GMAC_TX_CLK_DIV2_SUPPORTED)
    Frequency /= 2U;
#endif
    return Frequency;
}
...
static uint64 Clock_Ip_Get_GMAC1_TX_CLK_Frequency(void)
{
    ...
    Frequency /= ((((uint64)IP_MC_CGM->MUX_16_DC_0 & (uint64)MC_CGM_MUX_16_DC_0_DIV_MASK) >> (uint64)MC_CGM_MUX_16_DC_0_DIV_SHIFT) + 1U);                                     /*  Apply divider value */
    Frequency &= Clock_Ip_u32EnableGate[(IP_MC_ME->PRTN2_COFB1_STAT & MC_ME_PRTN2_COFB1_STAT_BLOCK34_MASK) >> MC_ME_PRTN2_COFB1_STAT_BLOCK34_SHIFT];
#if defined(CLOCK_IP_GMAC1_TX_CLK_DIV2_SUPPORTED)
    Frequency /= 2U;
#endif
    return Frequency;
}
...
#if defined(CLOCK_IP_TRACE_CLK_DIV2_SUPPORTED)
    Frequency /= 2U;
#endif
    return Frequency;
}

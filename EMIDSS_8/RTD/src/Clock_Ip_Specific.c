...
#define CLOCK_IP_SPECIFIC_SW_MAJOR_VERSION_C               7
...
static void Clock_Ip_CodeInRamSetFlashWaitStates(void)
{
...
#if defined(IP_FLASH0)
    RegValue = IP_FLASH0->CTL;
#else
    RegValue = IP_FLASH->CTL;
#endif /*defined(CLOCK_IP_DERIVATIVE_010)*/
    ...
    IP_FLASH0->CTL &= ~FLASH_CTL_RWSL_MASK;

    /* Configure wait states */
    IP_FLASH0->CTL = RegValue;
#else
    /* Unlock register to set flash wait states */
...
#ifdef CLOCK_IP_HAS_FLASH_WAIT_STATES
static void Clock_Ip_FLASH_SetFlashIWS(void);
...
/* SRAM SetUserAccessAllowed */
    ...
    #endif
    #if (defined(IP_PRAMC_2_BASE))
    SET_USER_ACCESS_ALLOWED(IP_PRAMC_2_BASE, PRAMC_PROT_MEM_U32);
    #endif
    #if (defined(IP_PRAMC_3_BASE))
    SET_USER_ACCESS_ALLOWED(IP_PRAMC_3_BASE, PRAMC_PROT_MEM_U32);
    #endif
  #endif
...
#if (defined(MCAL_C40ASF_REG_PROT_AVAILABLE ))
  #if (STD_ON == MCAL_C40ASF_REG_PROT_AVAILABLE )
    #if (defined(IP_FLASH0_BASE))
        SET_USER_ACCESS_ALLOWED(IP_FLASH0_BASE, C40ASF_PROT_MEM_U32);
    #endif
  #endif
#endif /* MCAL_C40ASF_REG_PROT_AVAILABLE  */
}
...
#endif
#ifdef IP_PRAMC_2
    uint32 Pram2RegVal = IP_PRAMC_2->PRCR1;
#endif
#ifdef IP_PRAMC_3
    uint32 Pram3RegVal = IP_PRAMC_3->PRCR1;
#endif
...
#endif
#ifdef IP_PRAMC_2
        Pram2RegVal |= PRAMC_PRCR1_FT_DIS_MASK;
#endif
#ifdef IP_PRAMC_3
        Pram3RegVal |= PRAMC_PRCR1_FT_DIS_MASK;
#endif
...
#endif
#ifdef IP_PRAMC_2
        Pram2RegVal &= ~PRAMC_PRCR1_P0_BO_DIS_MASK;
#endif
#ifdef IP_PRAMC_3
        Pram3RegVal &= ~PRAMC_PRCR1_P0_BO_DIS_MASK;
#endif
    }
    else
    {
...
#endif
#ifdef IP_PRAMC_2
    IP_PRAMC_2->PRCR1 = Pram2RegVal;
#endif
#ifdef IP_PRAMC_3
    IP_PRAMC_3->PRCR1 = Pram3RegVal;
#endif
    /* Complete all data memory accesses and instructions. */
    MCAL_INSTRUCTION_SYNC_BARRIER();
}

...
#define CLOCK_IP_DATA_SW_MAJOR_VERSION_C               7
...
#endif
#if defined(CLOCK_IP_HAS_FLEXCANC_CLK)
#define CLOCK_IP_FLEXCANC_EXTENSION                                 36U
#endif
...
#define CLOCK_IP_PRT2_COL2_REQ92_INDEX  217U
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN9_CLK)
#define CLOCK_IP_PRT2_COL2_REQ93_INDEX  218U
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN10_CLK)
#define CLOCK_IP_PRT2_COL2_REQ94_INDEX  219U
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN11_CLK)
#define CLOCK_IP_PRT2_COL2_REQ95_INDEX  220U
#endif
...
#endif
#if defined(CLOCK_IP_HAS_FLEXCANC_CLK)
#define CLOCK_IP_SEL_20_INDEX                            20U
#endif
...
#if defined(CLOCK_IP_DERIVATIVE_008) || defined(CLOCK_IP_DERIVATIVE_010)
...
#endif
#if defined(CLOCK_IP_HAS_FLEXCANC_CLK)
/*   FLEXCANC_CLK clock         */ {CLOCK_IP_CGM_0_INSTANCE,     CLOCK_IP_HWMUX_DIV,           CLOCK_IP_FLEXCANC_EXTENSION,      0U,    CLOCK_IP_SEL_20_INDEX,   CLOCK_IP_DIV_0_INDEX,   0U,                           0U,                     0U},                         /*   FLEXCANC_CLK clock         */
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN8_CLK)
/*   FLEXCAN8_CLK clock         */ {0U,                          CLOCK_IP_GATE,                0U,                               0U,    0U,                     0U,                     CLOCK_IP_PRT2_COL2_REQ92_INDEX,0U,                     0U},                         /*   FLEXCAN8_CLK clock         */
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN9_CLK)
/*   FLEXCAN9_CLK clock         */ {0U,                          CLOCK_IP_GATE,                0U,                               0U,    0U,                     0U,                     CLOCK_IP_PRT2_COL2_REQ93_INDEX,0U,                     0U},                         /*   FLEXCAN9_CLK clock         */
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN10_CLK)
/*   FLEXCAN10_CLK clock        */ {0U,                          CLOCK_IP_GATE,                0U,                               0U,    0U,                     0U,                     CLOCK_IP_PRT2_COL2_REQ94_INDEX,0U,                     0U},                         /*   FLEXCAN10_CLK clock         */
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN11_CLK)
/*   FLEXCAN11_CLK clock        */ {0U,                          CLOCK_IP_GATE,                0U,                               0U,    0U,                     0U,                     CLOCK_IP_PRT2_COL2_REQ95_INDEX,0U,                     0U},                         /*   FLEXCAN11_CLK clock         */
#endif
...
#endif
#if defined(CLOCK_IP_HAS_FLEXCANC_CLK)
/*   FLEXCANC_CLK clock         */ (CLOCK_IP_IRCOSC_OBJECT | CLOCK_IP_XOSC_OBJECT | CLOCK_IP_PLL_OBJECT | CLOCK_IP_SELECTOR_OBJECT | CLOCK_IP_DIVIDER_OBJECT | CLOCK_IP_DIVIDER_TRIGGER_OBJECT | CLOCK_IP_FRAC_DIV_OBJECT | CLOCK_IP_EXT_SIG_OBJECT | CLOCK_IP_GATE_OBJECT | CLOCK_IP_PCFS_OBJECT | CLOCK_IP_CMU_OBJECT) ,/*   FLEXCANC_CLK clock         */
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN8_CLK)
...
#endif
#if defined(CLOCK_IP_HAS_FLEXCANC_CLK)
        (Clock_Ip_CgmMuxType*)(&(IP_MC_CGM->MUX_20_CSC)),
#else
        NULL_PTR,
#endif
    },
...
/* CLOCK_IP_CMU_0_INSTANCE */
{
    ...
    CLOCK_IP_MAXIMUM_5_PERCENTAGE_DEVIATION,         /* Maximum allowed variation of reference clock: 5% for FIRC_CLK */
...
/* Reserved cmu instance */
{
    ...
    CLOCK_IP_MAXIMUM_5_PERCENTAGE_DEVIATION,         /* Maximum allowed variation of reference clock */
...
/* CLOCK_IP_CMU_3_INSTANCE */
{
    ...
    CLOCK_IP_MAXIMUM_0_POINT_01_PERCENTAGE_DEVIATION,/* Maximum allowed variation of reference clock: 0.01% for FXOSC_CLK */
    AIPS_SLOW_CLK,                                   /* Name of the bus clock */
...
{
    CLOCK_IS_OFF,              /* CLOCK_IS_OFF Clock */
};
...
#endif
#if defined(CLOCK_IP_HAS_FLEXCANC_CLK)
    {MC_CGM_MUX_20_CSC_SELCTL_MASK,         MC_CGM_MUX_20_CSC_SELCTL_SHIFT,         MC_CGM_MUX_20_DC_0_DIV_MASK,           MC_CGM_MUX_20_DC_0_DIV_SHIFT},             /*   CLOCK_IP_FLEXCANC_EXTENSION  */
#else
    {0U,                                    0U,                                     0U,                                    0U},
#endif
...
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN8_CLK)
    {CLOCK_IP_PARTITION_2_INDEX,       CLOCK_IP_COLLECTION_2_INDEX,      MC_ME_PRTN2_COFB2_CLKEN_REQ92_SHIFT,        MC_ME_PRTN2_COFB2_CLKEN_REQ92_MASK},        /*   FLEXCAN8_CLK clock         */
#else
    {0U,                               0U,                               0U,                                         0U},                                        /*   FLEXCAN8_CLK clock         */
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN9_CLK)
    {CLOCK_IP_PARTITION_2_INDEX,       CLOCK_IP_COLLECTION_2_INDEX,      MC_ME_PRTN2_COFB2_CLKEN_REQ93_SHIFT,        MC_ME_PRTN2_COFB2_CLKEN_REQ93_MASK},        /*   FLEXCAN9_CLK clock         */
#else
    {0U,                               0U,                               0U,                                         0U},                                        /*   FLEXCAN9_CLK clock         */
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN10_CLK)
    {CLOCK_IP_PARTITION_2_INDEX,       CLOCK_IP_COLLECTION_2_INDEX,      MC_ME_PRTN2_COFB2_CLKEN_REQ94_SHIFT,        MC_ME_PRTN2_COFB2_CLKEN_REQ94_MASK},        /*   FLEXCAN10_CLK clock         */
#else
    {0U,                               0U,                               0U,                                         0U},                                        /*   FLEXCAN10_CLK clock         */
#endif
#if defined(CLOCK_IP_HAS_FLEXCAN11_CLK)
    {CLOCK_IP_PARTITION_2_INDEX,       CLOCK_IP_COLLECTION_2_INDEX,      MC_ME_PRTN2_COFB2_CLKEN_REQ95_SHIFT,        MC_ME_PRTN2_COFB2_CLKEN_REQ95_MASK},        /*   FLEXCAN11_CLK clock         */
#else
    {0U,                               0U,                               0U,                                         0U},                                        /*   FLEXCAN11_CLK clock         */
#endif
};

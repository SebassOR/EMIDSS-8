...
/**
*   @file OsIf_Interrupts.c
*   @version 7.0.0
*
*   @brief   BaseNXP - Implements the driver functionality.
*   @details Implements the Interrupts APIs using for ZEPHYR OS and FREERTOS.
*
*   @addtogroup osif_drv
*   @{
*/
...
#define OSIF_INTERRUPTS_AR_RELEASE_MINOR_VERSION_C     9
#define OSIF_INTERRUPTS_AR_RELEASE_REVISION_VERSION_C  0
#define OSIF_INTERRUPTS_SW_MAJOR_VERSION_C             7

...
#define DET_STUB_AR_RELEASE_MINOR_VERSION_C      9
#define DET_STUB_AR_RELEASE_REVISION_VERSION_C   0
#define DET_STUB_SW_MAJOR_VERSION_C              7
...
boolean Det_TestNoError(void)
{
    ...
    {
        if (Det_numEventErrors[u32PartId] != 0)
        {
            result = FALSE;
        }
...
boolean Det_TestNoRuntimeError(void)
{
    ...
    {
        if (Det_numRuntimeEventErrors[u32PartId] != 0)
        {
            result = FALSE;
        }
...
boolean Det_TestNoTransientFault(void)
{
    ...
    {
        if (Det_numTransientEventErrors[u32PartId] != 0)
        {
            result = FALSE;
        }

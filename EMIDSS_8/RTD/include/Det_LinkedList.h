...
#define DET_LINKEDLIST_AR_RELEASE_MINOR_VERSION      9
#define DET_LINKEDLIST_AR_RELEASE_REVISION_VERSION   0
#define DET_LINKEDLIST_SW_MAJOR_VERSION              7
...
extern Det_ModuleStateType Det_ModuleState[DET_NO_ECU_PARTS];
...
extern Det_LinkedListStateType Det_aErrorState[DET_NO_ECU_PARTS];
/**< @brief state of linked list Runtime Det error */
extern Det_LinkedListStateType Det_aRuntimeErrorState[DET_NO_ECU_PARTS];
/**< @brief state of linked list Transient Det error */
extern Det_LinkedListStateType Det_aTransientErrorState[DET_NO_ECU_PARTS];

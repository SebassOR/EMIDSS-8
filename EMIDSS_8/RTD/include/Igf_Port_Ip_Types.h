...
#define IGF_PORT_IP_TYPES_AR_RELEASE_MINOR_VERSION_H      9
#define IGF_PORT_IP_TYPES_AR_RELEASE_REVISION_VERSION_H   0
#define IGF_PORT_IP_TYPES_SW_MAJOR_VERSION_H              7
...
=================================================================================================*/
    ...
    /* Check if the files Igf_Port_Ip_Types.h and Common_Types.h are of the same version */
        ...
        #error "AutoSar Version Numbers of Igf_Port_Ip_Types.h and Common_Types.h are different"
    #endif
#endif

...
#define LPSPI_IP_TYPES_AR_RELEASE_MINOR_VERSION       9
#define LPSPI_IP_TYPES_AR_RELEASE_REVISION_VERSION    0
#define LPSPI_IP_TYPES_SW_MAJOR_VERSION               7
...
typedef struct
{
    ...
    uint32 Ccr1[2u];    /**< CCR1 register which contains clocking and frame size configuration. */
    ...
    uint32 Ccr1;   /**< CCR1 register which contains clocking and frame size configuration. */

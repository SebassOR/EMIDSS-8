...
#define CLOCK_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION                7
...
/**
 * @brief         Reset FERD register
 *
 * @param        None
 * @return       None
 *
 */
extern void Clock_Ip_ResetFerd_TrustedCall(void);

/**
 * @brief         Set FERD register
 *
 * @param        None
 * @return       None
 *
 */
extern void Clock_Ip_SetFerd_TrustedCall(void);
#endif
 ...
 *
 */
extern uint64 Clock_Ip_Get_RTC_CLK_Frequency_TrustedCall(void);
#endif
#endif

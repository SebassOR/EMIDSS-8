...
#define CLOCK_IP_TYPES_SW_MAJOR_VERSION                7
...
#endif
#if defined(CLOCK_IP_HAS_COREPLL_PHI10_CLK)
    COREPLL_PHI10_CLK          = CLOCK_IP_HAS_COREPLL_PHI10_CLK,
#endif
...
#endif
#if defined(CLOCK_IP_HAS_DDRPLL_DFS1_CLK)
    DDRPLL_DFS1_CLK           = CLOCK_IP_HAS_DDRPLL_DFS1_CLK,
#endif
...
#endif
#if defined(CLOCK_IP_HAS_PERIPHPLL_PHI10_CLK)
    PERIPHPLL_PHI10_CLK        = CLOCK_IP_HAS_PERIPHPLL_PHI10_CLK,
#endif
#if defined(CLOCK_IP_HAS_PERIPHPLL_PHI11_CLK)
    PERIPHPLL_PHI11_CLK        = CLOCK_IP_HAS_PERIPHPLL_PHI11_CLK,
#endif
#if defined(CLOCK_IP_HAS_PERIPHPLL_PHI12_CLK)
    PERIPHPLL_PHI12_CLK        = CLOCK_IP_HAS_PERIPHPLL_PHI12_CLK,
#endif
...
#endif
#if defined(CLOCK_IP_HAS_A53_CORE_0_CLK)
    A53_CORE_0_CLK              = CLOCK_IP_HAS_A53_CORE_0_CLK,
#endif
#if defined(CLOCK_IP_HAS_A53_CORE_1_CLK)
    A53_CORE_1_CLK              = CLOCK_IP_HAS_A53_CORE_1_CLK,
#endif
#if defined(CLOCK_IP_HAS_A53_CORE_2_CLK)
    A53_CORE_2_CLK              = CLOCK_IP_HAS_A53_CORE_2_CLK,
#endif
#if defined(CLOCK_IP_HAS_A53_CORE_3_CLK)
    A53_CORE_3_CLK              = CLOCK_IP_HAS_A53_CORE_3_CLK,
#endif
...
THE_LAST_PRODUCER_CLK         = CLOCK_IP_FEATURE_PRODUCERS_NO,     /* Number of producers clocks */
    ...
    FLEXCANC_CLK              = CLOCK_IP_HAS_FLEXCANC_CLK,
#endif
...
#endif
#if defined(CLOCK_IP_HAS_CSI_TXCLK_ESC_CLK)
    CSI_TXCLK_ESC_CLK             = CLOCK_IP_HAS_CSI_TXCLK_ESC_CLK,
#endif
...
#endif
#if defined(CLOCK_IP_HAS_SYS_M7_2_CLK)
    SYS_M7_2_CLK              = CLOCK_IP_HAS_SYS_M7_2_CLK,
#endif
...
#endif
#if defined(CLOCK_IP_HAS_MIPICSI2_2_CLK)
    MIPICSI2_2_CLK            = CLOCK_IP_HAS_MIPICSI2_2_CLK,
#endif
#if defined(CLOCK_IP_HAS_MIPICSI2_3_CLK)
    MIPICSI2_3_CLK            = CLOCK_IP_HAS_MIPICSI2_3_CLK,
#endif
...
#endif
#if defined(CLOCK_IP_HAS_SPT0_CLK)
    SPT0_CLK                   = CLOCK_IP_HAS_SPT0_CLK,
#endif
#if defined(CLOCK_IP_HAS_SPT1_CLK)
    SPT1_CLK                   = CLOCK_IP_HAS_SPT1_CLK,
#endif
...
#endif
#if defined(CLOCK_IP_HAS_GMAC2_TS_CLK)
    GMAC2_TS_CLK          = CLOCK_IP_HAS_GMAC2_TS_CLK,
#endif
#if defined(CLOCK_IP_HAS_PPA_0_CLK)
    PPA_0_CLK          = CLOCK_IP_HAS_PPA_0_CLK,
#endif
#if defined(CLOCK_IP_HAS_PPA_1_CLK)
    PPA_1_CLK          = CLOCK_IP_HAS_PPA_1_CLK,
#endif
#if defined(CLOCK_IP_HAS_SERDES_PCIE_ENET_REF_CLK)
    SERDES_PCIE_ENET_REF_CLK          = CLOCK_IP_HAS_SERDES_PCIE_ENET_REF_CLK,
#endif
#if defined(CLOCK_IP_HAS_SERDES_2X_ENET_REF_CLK)
    SERDES_2X_ENET_REF_CLK          = CLOCK_IP_HAS_SERDES_2X_ENET_REF_CLK,
#endif
#if defined(CLOCK_IP_HAS_DDR_PLLBY_CLK)
    DDR_PLLBY_CLK          = CLOCK_IP_HAS_DDR_PLLBY_CLK,
#endif
#if defined(CLOCK_IP_HAS_DDR_DIV4_CLK)
    DDR_DIV4_CLK          = CLOCK_IP_HAS_DDR_DIV4_CLK,
#endif
#if defined(CLOCK_IP_HAS_BBE32EP_DSP0_CLK)
    BBE32EP_DSP0_CLK          = CLOCK_IP_HAS_BBE32EP_DSP0_CLK,
#endif
#if defined(CLOCK_IP_HAS_BBE32EP_DSP1_CLK)
    BBE32EP_DSP1_CLK          = CLOCK_IP_HAS_BBE32EP_DSP1_CLK,
#endif
#if defined(CLOCK_IP_HAS_CSI_PLL_REF_CLK)
    CSI_PLL_REF_CLK          = CLOCK_IP_HAS_CSI_PLL_REF_CLK,
#endif
...
typedef struct
{
    ...
    uint64                        ClockSourceFrequency;        /**<  Frequency of the clock source from which ramp-down and to which ramp-up are processed. */

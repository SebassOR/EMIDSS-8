...
#endif
#if defined(CLOCK_IP_DERIVATIVE_010)
    #include "Clock_Ip_Derivative_010.h"
#endif
...
#define CLOCK_IP_SPECIFIC_SW_MAJOR_VERSION                7
...
#if defined(CLOCK_IP_DERIVATIVE_010)
    /* Check if Clock_Ip_Specific.h file and Clock_Ip_Derivative_010.h file have same versions */
    #if (CLOCK_IP_SPECIFIC_VENDOR_ID  != CLOCK_IP_DERIVATIVE_010_VENDOR_ID)
        #error "Clock_Ip_Specific.h and Clock_Ip_Derivative_010.h have different vendor IDs"
    #endif

    /* Check if Clock_Ip_Specific.h file and Clock_Ip_Derivative_010.h file are of the same Autosar version */
    #if ((CLOCK_IP_SPECIFIC_AR_RELEASE_MAJOR_VERSION    != CLOCK_IP_DERIVATIVE_010_AR_RELEASE_MAJOR_VERSION) || \
         (CLOCK_IP_SPECIFIC_AR_RELEASE_MINOR_VERSION    != CLOCK_IP_DERIVATIVE_010_AR_RELEASE_MINOR_VERSION) || \
         (CLOCK_IP_SPECIFIC_AR_RELEASE_REVISION_VERSION != CLOCK_IP_DERIVATIVE_010_AR_RELEASE_REVISION_VERSION))
        #error "AutoSar Version Numbers of Clock_Ip_Specific.h and Clock_Ip_Derivative_010.h are different"
    #endif

    /* Check if Clock_Ip_Specific.h file and Clock_Ip_Derivative_010.h file are of the same Software version */
    #if ((CLOCK_IP_SPECIFIC_SW_MAJOR_VERSION != CLOCK_IP_DERIVATIVE_010_SW_MAJOR_VERSION) || \
         (CLOCK_IP_SPECIFIC_SW_MINOR_VERSION != CLOCK_IP_DERIVATIVE_010_SW_MINOR_VERSION) || \
         (CLOCK_IP_SPECIFIC_SW_PATCH_VERSION != CLOCK_IP_DERIVATIVE_010_SW_PATCH_VERSION))
        #error "Software Version Numbers of Clock_Ip_Specific.h and Clock_Ip_Derivative_010.h are different"
    #endif
#endif
...
#define CLOCK_IP_MC_CGM_MUXS_COUNT           21U
...
#define CLOCK_IP_GATE_INFO_SIZE              221U
#define CLOCK_IP_EXTENSIONS_SIZE             37U
...
#if (defined(CLOCK_IP_DERIVATIVE_001) || defined(CLOCK_IP_DERIVATIVE_002) || defined(CLOCK_IP_DERIVATIVE_004) || defined(CLOCK_IP_DERIVATIVE_005))

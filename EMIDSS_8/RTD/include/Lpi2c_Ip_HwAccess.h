...
#define LPI2C_IP_HWACCESS_AR_RELEASE_MINOR_VERSION       9
#define LPI2C_IP_HWACCESS_AR_RELEASE_REVISION_VERSION    0
#define LPI2C_IP_HWACCESS_SW_MAJOR_VERSION               7
...
static inline uint16  LPI2C_Get_MasterRxFIFOSize(const LPI2C_Type *BaseAddr)
{
    ...
    MrxFifo = (Tmp & LPI2C_PARAM_MRXFIFO_MASK) >> LPI2C_PARAM_MRXFIFO_SHIFT;
    Tmp = 1UL << MrxFifo;     /* RX FIFO size = 2^MRXFIFO */

    return (uint16)(Tmp & 0xFFFFU);
}
...
static inline uint16 LPI2C_Get_MasterTxFIFOSize(const LPI2C_Type *BaseAddr)
{
    ...
    MtxFifo = (Tmp & LPI2C_PARAM_MTXFIFO_MASK) >> LPI2C_PARAM_MTXFIFO_SHIFT;
    Tmp = 1UL << MtxFifo;      /* TX FIFO size = 2^MTXFIFO */
                                                 ...
                                                 boolean Enable)
{
    ...
    RegValue |= LPI2C_MCR_RST((Enable == TRUE) ? 1U : 0U);
    BaseAddr->MCR = (uint32)RegValue;
}
...
static inline void LPI2C_Set_MasterEnable(LPI2C_Type *BaseAddr, boolean Enable)
{
    ...
    RegValue |= LPI2C_MCR_MEN((Enable == TRUE) ? 1U : 0U);
    BaseAddr->MCR = (uint32)RegValue;
}
 ...
 *
 * @details This function enables or disables the debug mode in master mode.
 *
 * @param[in] BaseAddr  base address of the LPI2C module
 * @param[in] Enable  specifies whether to enable or disable the LPI2C master
 */
static inline void LPI2C_Set_MasterEnableDebugMode(LPI2C_Type *BaseAddr, boolean Enable)
{
    uint32 RegValue = (uint32)BaseAddr->MCR;
    RegValue &= (~(LPI2C_MCR_DBGEN_MASK));
    RegValue |= LPI2C_MCR_DBGEN((Enable == TRUE) ? 1U : 0U);
    BaseAddr->MCR = (uint32)RegValue;
}
                                         ...
                                         boolean Enable)
{
    ...
    RegValue |= LPI2C_MDER_RDDE((Enable == TRUE) ? 1U : 0U);
                                         ...
                                         boolean Enable)
{
    ...
    RegValue |= LPI2C_MDER_TDDE((Enable == TRUE) ? 1U : 0U);
    BaseAddr->MDER = (uint32)RegValue;
}
                                                              ...
                                                              boolean Configuration)
{
    ...
    Tmp |= LPI2C_MCFGR1_TIMECFG((Configuration == TRUE) ? 1U : 0U);
    BaseAddr->MCFGR1 = (uint32)Tmp;
}
                                                ...
                                                boolean Enable)
{
    ...
    RegValue |= LPI2C_SCR_RST((Enable == TRUE) ? 1U : 0U);
    BaseAddr->SCR = (uint32)RegValue;
}
                                        ...
                                        boolean Enable)
{
    ...
    RegValue |= LPI2C_SDER_RDDE((Enable == TRUE) ? 1U : 0U);
                                        ...
                                        boolean Enable)
{
    ...
    RegValue |= LPI2C_SDER_TDDE((Enable == TRUE) ? 1U : 0U);
    BaseAddr->SDER = (uint32)RegValue;
}
                                                      ...
                                                      boolean Enable)
{
    ...
    RegValue |= LPI2C_SCFGR1_HSMEN((Enable == TRUE) ? 1U : 0U);
                                           ...
                                           boolean Enable)
{
    ...
    RegValue |= LPI2C_SCFGR1_ACKSTALL((Enable == TRUE) ? 1U : 0U);
    BaseAddr->SCFGR1 = (uint32)RegValue;
}
                                           ...
                                           boolean Enable)
{
    ...
    RegValue |= LPI2C_SCFGR1_TXDSTALL((Enable == TRUE) ? 1U : 0U);
    BaseAddr->SCFGR1 = (uint32)RegValue;
}
                                          ...
                                          boolean Enable)
{
    ...
    RegValue |= LPI2C_SCFGR1_RXSTALL((Enable == TRUE) ? 1U : 0U);
    BaseAddr->SCFGR1 = (uint32)RegValue;
}
                                            ...
                                            boolean Enable)
{
    ...
    RegValue |= LPI2C_SCFGR1_ADRSTALL((Enable == TRUE) ? 1U : 0U);
    BaseAddr->SCFGR1 = (uint32)RegValue;
}

/**
 * @brief Set Clock Hold Time
 *
 * @details This function configures the minimum clock hold time for the I2C target,
 *          when clock stretching is enabled. The minimum hold time is equal to the
 *          number of cycles defined by this field + 3
 *
 * @param[in] BaseAddr  base address of the LPI2C module
 * @param[in] ClkHold   Number of minimum clocks to hold
 */
static inline void LPI2C_Set_SlaveClkHold(LPI2C_Type *BaseAddr, uint8 ClkHold)
{
    uint32 RegValue = (uint32)BaseAddr->SCFGR2;
    RegValue &= (~(LPI2C_SCFGR2_CLKHOLD_MASK));
    RegValue |= LPI2C_SCFGR2_CLKHOLD((uint32)ClkHold - 3u);
    BaseAddr->SCFGR2 = (uint32)RegValue;
}
                                       ...
                                       boolean Enable)
{
    ...
    RegValue |= LPI2C_MCFGR0_RELAX((Enable == TRUE) ? 1U : 0U);

...
#define OSIF_SOFTWARE_SEMAPHORE_AR_RELEASE_MINOR_VERSION_H     9
#define OSIF_SOFTWARE_SEMAPHORE_AR_RELEASE_REVISION_VERSION_H  0
#define OSIF_SOFTWARE_SEMAPHORE_SW_MAJOR_VERSION_H             7
 ...
 */
boolean OsIf_Software_Semaphore_Lock(uint32 *Semaphore,
                                     uint32 Lockval
                                    );
 ...
 * @param[in] Lockval the lock value
 */
boolean OsIf_Software_Semaphore_Unlock(uint32 *Semaphore,
                                       uint32 Lockval
                                      );

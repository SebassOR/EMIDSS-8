 ...
 *       - NOT_OK 	: Device is not acknowledging I2C address
 */
Std_ReturnType ms8607_get_humidity_battery_status(uint8_t *battStatus);
 ...
 *       - NOT_OK 	: Device is not acknowledging I2C address
 */
Std_ReturnType ms8607_enable_humidity_heater(void);
 ...
 *       - NOT_OK 	: Device is not acknowledging I2C address
 */
Std_ReturnType ms8607_disable_humidity_heater(void);
 ...
 *       - NOT_OK 	: Device is not acknowledging I2C address
 */
Std_ReturnType ms8607_get_heater_status(uint8_t *heaterStatus);

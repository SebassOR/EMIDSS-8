...
const Lpi2c_Ip_MasterConfigType I2c_Lpi2cMaster_HwChannel1_Channel0 =
{
    /* .SlaveAddress */     99U,
...
const Lpi2c_Ip_MasterConfigType I2c_Lpi2cMaster_HwChannel0_Channel1 =
{
    /* .SlaveAddress */     64U,
    /* .DebugMode */        (boolean)FALSE,
    /* .Is10bitAddr */      (boolean)FALSE,
    /* .OperatingMode */    LPI2C_FAST_MODE,
    /* .BaudrateParams */   &baudrateParams1,
    /* .PinLowTimeout */    0U,
    /* .BusIdleTimeout */   0U,
    /* .GlitchFilterSDA */  0U,
    /* .GlitchFilterSCL */  0U,

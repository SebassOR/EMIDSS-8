...
#define LPSPI_IP_SA_AR_RELEASE_MINOR_VERSION_PBCFG_C         9
#define LPSPI_IP_SA_AR_RELEASE_REVISION_VERSION_PBCFG_C      0
#define LPSPI_IP_SA_SW_MAJOR_VERSION_PBCFG_C                 7
...
#error "Software Version Numbers of Lpspi_Ip.h and Lpspi_Ip_Sa_PBcfg.c are different"
        ...
        #if ((DMA_IP_CFG_AR_RELEASE_MAJOR_VERSION != LPSPI_IP_SA_AR_RELEASE_MAJOR_VERSION_PBCFG_C) || \
             (DMA_IP_CFG_AR_RELEASE_MINOR_VERSION != LPSPI_IP_SA_AR_RELEASE_MINOR_VERSION_PBCFG_C))
        #error "AutoSar Version Numbers of Lpspi_Ip_Sa_PBcfg.c and Dma_Ip_Cfg.h are different"
        #endif
    #endif
#endif
/*==================================================================================================
...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_1_Instance_1 =
{
    1U,  /* Instance */
    (uint32)(LPSPI_CFGR0_HRDIR(0U) | LPSPI_CFGR0_HREN(0U) |
             LPSPI_CFGR0_HRSEL(0U) | LPSPI_CFGR0_HRPOL(0U)), /* CFGR0 */
        (uint32)(LPSPI_CCR_SCKPCS(29U) | LPSPI_CCR_PCSSCK(29U)), /* ccr */
        (uint32)(LPSPI_CCR1_SCKSCK(28U) | LPSPI_CCR1_PCSPCS(14U) | LPSPI_CCR1_SCKHLD(14U) | LPSPI_CCR1_SCKSET(14U)), /* ccr1 */
        (uint32)(LPSPI_TCR_WIDTH(0U) | LPSPI_TCR_CPOL(1U) | LPSPI_TCR_CPHA(1U) | LPSPI_TCR_PRESCALE(0U) | LPSPI_TCR_PCS(1U) | LPSPI_TCR_CONT(1U)) /* TCR */

...
outputs:
- {id: ADC0_CLK.outFreq, value: 4 MHz}
- {id: ADC1_CLK.outFreq, value: 4 MHz}
...
- {id: FTFM0_CLK.outFreq, value: 12 MHz}
- {id: FTM0_CLK.outFreq, value: 4 MHz}
- {id: FTM1_CLK.outFreq, value: 4 MHz}
- {id: FTM2_CLK.outFreq, value: 4 MHz}
- {id: FTM3_CLK.outFreq, value: 4 MHz}
- {id: FlexIO0_CLK.outFreq, value: 4 MHz}
- {id: LPI2C0_CLK.outFreq, value: 4 MHz}
- {id: LPIT0_CLK.outFreq, value: 4 MHz}
- {id: LPO_1K_CLK.outFreq, value: 1 kHz}
- {id: LPO_CLK.outFreq, value: 128 kHz}
- {id: LPSPI0_CLK.outFreq, value: 4 MHz}
- {id: LPSPI1_CLK.outFreq, value: 4 MHz}
- {id: LPSPI2_CLK.outFreq, value: 4 MHz}
- {id: LPTMR0_CLK.outFreq, value: 4 MHz}
...
- {id: 'VLPR:SCG.DIVBUS.scale', value: '2', locked: true}
- {id: 'VLPR:SCG.DIVCORE.scale', value: '8', locked: true}
...
clock_manager_user_config_t clockMan1_InitConfig0 = {
    .scgConfig =
    {
        .sircConfig =
        {
            ...
            .div1 = SCG_ASYNC_CLOCK_DIV_BY_2,     /* Slow IRC Clock Divider 1: divided by 2 */
            .div2 = SCG_ASYNC_CLOCK_DIV_BY_2,     /* Slow IRC Clock Divider 3: divided by 2 */
        },
        .fircConfig =
        {
            .initialize = true,
        ...
        .spllConfig =
        {
            ...
            .mult = (uint8_t)SCG_SPLL_CLOCK_MULTIPLY_BY_40,/* Multiply Factor is 40 */
            .src = 0U,
